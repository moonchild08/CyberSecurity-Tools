...
def main():
    ...
    parser.add_argument("--min_length", type=int, help="Minimum length of generated passwords", default=1)
    parser.add_argument("--max_length", type=int, help="Maximum length of generated passwords", default=4)
